...
export default function Sidebar({ isSidebarOpen, toggleSidebar }) {
        ...
        {item.dropdown ? (
          <div>
            <button
              ...
              className={`flex items-center justify-between w-full px-3 sm:px-3.5 py-2 sm:py-3 rounded-lg text-sm sm:text-base ${
            ...
            >
              ...
              <svg
                className={`w-4 h-4 sm:w-5 sm:h-5 transform ${openDropdowns[item.id] ? 'rotate-180' : ''}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
            ...
            {openDropdowns[item.id] && (
              <div className="pl-6 sm:pl-8 space-y-1 sm:space-y-2 mt-1 sm:mt-2">
                {item.dropdown.map((subItem, index) => (
                  <Link
                    key={index}
                    href={subItem.href}
                    className={`flex items-center px-3 sm:px-3.5 py-2 sm:py-3 rounded-lg text-xs sm:text-sm ${
          ...
          <Link
            href={item.href}
            className={`flex items-center px-3 sm:px-3.5 py-2 sm:py-3 rounded-lg text-sm sm:text-base ${
              pathname === item.href
                ? 'bg-[rgba(87,80,241,0.07)] text-[#5750f1]'
                : 'text-[#4b5563] hover:bg-gray-100 hover:text-black'
            }`}
  ...
  return (
    <div
      className={`fixed top-0 left-0 w-[75vw] sm:w-[250px] md:w-[270px] lg:w-[290px] h-full bg-white border-r-[1px] border-[#e5e7eb] transform lg:transform-none transition-transform duration-300 ${
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-3 sm:p-4 scrollbar-thin scrollbar-thumb-[#5750f1] scrollbar-track-gray-100 scrollbar-thumb-rounded-full">
